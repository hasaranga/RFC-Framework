...
public:
	...
	*/
	static bool showOpenFileDialog(KWindow* window, const KString& title, const wchar_t* filter, 
		KString* fileName, bool saveLastLocation = false, const KString& dialogGuid = KString()) noexcept;
	...
	/**
		...
		"dialogGuid" is valid only if "saveLastLocation" is true.
	*/
	static bool showSaveFileDialog(KWindow* window, const KString& title, const wchar_t* filter, 
		KString* fileName, bool saveLastLocation = false, const KString& dialogGuid = KString()) noexcept;
};
