...
func main() {
	...
	flag.Usage = func() {
		fmt.Fprintf(os.Stderr, "RFC Builder CLI - A tool to combine selected RFC modules into a single header and C++ source pair.\n\n")
		fmt.Fprintf(os.Stderr, "Usage:\n")
		fmt.Fprintf(os.Stderr, "  rfc-builder [options] [modules...]\n\n")
		fmt.Fprintf(os.Stderr, "Examples:\n")
		fmt.Fprintf(os.Stderr, "  rfc-builder gui file thread\n")
		fmt.Fprintf(os.Stderr, "  rfc-builder -m gui,file,thread -o ./output\n")
		fmt.Fprintf(os.Stderr, "  rfc-builder --rfc-dir C:\\agent\\rfc_test\\rfc -o build -n rfc_amalgamated\n\n")
